...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vote_button.setGeometry(QtCore.QRect(210, 440, 261, 71))
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(False)
        font.setWeight(50)
        self.vote_button.setFont(font)
        self.vote_button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.vote_button.setAutoFillBackground(False)
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(150, 230, 171, 81))
        font = QtGui.QFont()
